...
namespace MVCApp.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseId,EnrollDate")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,CourseId,EnrollDate")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
